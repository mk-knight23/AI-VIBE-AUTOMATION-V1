...
import { Bot, Zap, Clock, TrendingUp, Plus, ArrowRight, Loader2 } from "lucide-react";
...
export default function DashboardPage() {
    ...
    const stats = [
        ...
        {
            title: "Total Runs",
            value: workflows.reduce((sum: number, workflow: any) => sum + (workflow.runCount || 0), 0),
            icon: Zap,
        ...
        {
            title: "Last Active",
            value: workflows.length > 0 ? "Today" : "N/A",
            icon: Clock,
                            ...
                            {workflows.slice(0, 5).map((workflow: any) => (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-medium group-hover:text-violet-300 transition-colors">{workflow.name}</h4>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <Badge
                                            ...
                                            className={workflow.isActive ? "bg-emerald-500/20 text-emerald-400 border-emerald-500/30" : ""}
                                        >
